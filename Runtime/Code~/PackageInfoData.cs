...
namespace YIUIFramework.Editor
{
    ...
    public class PackageInfoData
    {
        ...
        {
            Version        = Regex.Replace(Version, YIUIPackagesModule.Pattern, "");
            m_VersionValue = null;
        }
        ...
        public int[] VersionValue
        {
            get
            {
                if (m_VersionValue == null)
                {
                    ...
                    var versionSplit = Regex.Replace(Version, YIUIPackagesModule.Pattern, "").Split('.');
        ...
        {
            var packageInfo = YIUIPackagesModule.Inst.GetSourcePackageInfoData(Name);
            if (packageInfo == null)
            {
                return;
            }
        ...
        public void UpdateDependencies()
        {
            ...
            {
                var packageInfo = YIUIPackagesModule.Inst.GetPackageInfoData(data.Name);
                if (packageInfo == null)
                {
                    return;
                }
            ...
            YIUIPackagesModule.Inst.SyncPackageUpdate(Name, LastVersion);
        }
