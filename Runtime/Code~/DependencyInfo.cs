...
namespace YIUIFramework.Editor
{
    ...
    public class DependencyInfo
    {
        ...
        public void SyncVersion()
        {
            ...
            var packageInfo = YIUIPackagesModule.Inst.GetPackageInfoData(Name);
            if (packageInfo == null)
            {
                return;
            }
            ...
            if (!YIUIPackagesModule.Inst.SyncDependency) return;
        ...
        public void SyncSelfVersion()
        {
            ...
            var packageInfo = YIUIPackagesModule.Inst.GetPackageInfoData(SelfName);
            if (packageInfo == null)
            {
                return;
            }
            ...
            packageInfo = YIUIPackagesModule.Inst.GetPackageInfoData(Name);
            if (packageInfo == null)
            {
                return;
            }
